...
namespace Morgenmadsbuffeten_GruppeTo.Controllers
{
    public class GuestsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GuestId,RoomNbr,AdultCount,ChildCount")] Guest guest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GuestId,RoomNbr,AdultCount,ChildCount")] Guest guest)
        {
            if (id != guest.GuestId)
            {
                return NotFound();
